...
public class SudokuBoardView extends View {
	...
	private static final int NO_COLOR = 0; //TRANSPARENT
	...
	public void setBackgroundColorSelected(int color) {
		...
		mBackgroundColorSelected.setAlpha(100); //opacity
	}
	...
	@Override
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) { //measure the view and its content
